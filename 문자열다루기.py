...
print("저의 이름은 \"나이키\" 입니다.")

# 이스케이프 문자 사용하기 
print("서울시\t송파구\t문정동")
print("사과\r바나나\r오렌지")

# 인덱싱 (슬라이싱) : 인덱스 항상 0에서 부터 시작 합니다. 
jumin = "991120-1234567"

print("성별 : " + jumin[7]) # 1은 남성 
print("태어난 년도 : " + jumin[:2]) # 시작 인덱스를 주지 않으면 0에서 시작하고 end는 미만 개념이 있음
...
# 갯수 세기 : count()
# 길이 반환 : __len__(), len()
print(input_str.count("l")) #"l" 문자가 몇 번 나오는지 갯수 세기 
...
# index() : 찾은 문자열의 첫 번째 인섹스 반환, 문자열을 찾지 못하면 ValueError 라는 예외를 발생 시킴
